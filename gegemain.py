...
if __name__ == "__main__":
    ...
    while fenlist < len(gegelist):
        ...
        while j < tp.pages + 1:
            ...
            urll = host + '/lc/' + str(tp.index) + '-' + str(j - 1) + '.html'
            try:
                ...
                for ri, r in enumerate(rows):
                    try:
                        ...
                        for flag in book_root.xpath(
                                '//td[@class="style2"]//div[2]/a[position()>1 and position() < last()-1]//text()'):
                        ...
                        for cptOne in bookOne.chapters:
                            ...
                            page_contents = page_root.xpath(
                                '//table[last()]//div[5]//text()[position()>1 and position()<last()]')
                            ...
                            if cptOne.title in cptOne.paragraphs and cptOne.paragraphs.index(cptOne.title) < len(
                                    cptOne.paragraphs) / 2:
